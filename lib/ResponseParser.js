...
class ResponseParser {
  ...
  ItemInformation () {
    ...
    data.holdPickupDate = this.#formatDueDate(utils.parseFirstVariable('CM', payload))
  ...
  PatronResponse () {
    ...
    const data = { ...this.#parsePatronBlocks() }
  ...
  #parsePatronBlocks () {
    ...
    status.renewalPrivilegesDenied = utils.charEmptyToBool(this.message.charAt(3))
    ...
    return this.verbose ? { blocks, status } : { blocks }
  }
